...
echo -e "\e[0m"
echo "=================================================="
echo -e "\e[1;32m Обновляем пакеты\e[0m"
sudo apt update && sudo apt upgrade -y
echo -e "\e[1;32m Docker...\e[0m" && sleep 1
...
read -p "Введите имя для вашей ноды: " NODE_ID < /dev/tty
echo -e "\e[1;32mПишем тут сколько ваша нода будет использовать памяти в формате 100G \e[0m"
read -p "Используемое пространство: " PLOT_SIZE < /dev/tty
echo '================================================='
echo -e "Имя ноды: \e[1m\e[32m$NODE_ID\e[0m"
echo -e "Адрес кошелька: \e[1m\e[32m$WALLET_SUBSPACE\e[0m"
echo -e "Используемое пространство: \e[1m\e[32m$PLOT_SIZE\e[0m"
echo -e '================================================='
echo "
